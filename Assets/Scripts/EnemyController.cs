...
public class EnemyController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        intervaloSonidos = Random.Range(7, 11);
        SoundingIdle();
    ...
    {
        mIsAttacking = true;
        audioS.clip = zombieAttackSound[Random.Range(0,1)];
        audioS.Play();
    }
    ...
    public void TakeDamage(float damage)
    {
        ...
        {
            Destroy(gameObject);
            OleadasM.puntuacion += 10;
        }
    }

    private void SoundingIdle()
    {
        audioS.clip = zombieIdleSound;
        audioS.Play();
    }
}
